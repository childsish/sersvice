...
$('#run').click(function() {
    ...
    $('#content').html('<tr><th>Sample</th><th>Chromosome</th><th>Position</th><th>Gene name</th><th>Amino acid variant</th><th>Variant type</th><th>Proximity Bounds</th><th>Homopolymer</th><th>SNP allele frequency</th><th>Quality</th><th>Alternate count</th><th>Reference count</th></tr>')
    worker.postMessage( {
        message: 'run'
    })
})
